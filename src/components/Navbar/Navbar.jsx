  ...
  return (
    <div className='navbar'>
      ...
      <ul ref={menuRef} className="nav-menu">
        ...
        <li><AnchorLink className='anchor-link' offset={50} href='#work'><p onClick={()=>setMenu("work")}>My Portfolio</p></AnchorLink>{menu==="work"?<img src={underline}/>:<></>}</li>
      ...
      <div className="nav-connect"><AnchorLink className='anchor-link' offset={50} href='#contact'>Get connected</AnchorLink></div>
    </div>
  )
}
